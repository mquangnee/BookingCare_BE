...
namespace BookingCare.Infrastructure.Migrations
{
    ...
    [Migration("20260329113659_seed_worksession_data")]
    partial class seed_worksession_data
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookingCare.Domain.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DurationInMinutes = 15,
                            IsActive = true,
                            Name = "Khám Bác sĩ - Cơ Xương Khớp",
                            Position = 0,
                            Price = 150000.0,
                            ServiceCode = "KHAM-CXK-BS",
                            SpecialtyId = new Guid("11111111-1111-1111-1111-111111111101")
                        },
                        new
                        {
                            ...
                            DurationInMinutes = 15,
                            IsActive = true,
                            Name = "Khám Thạc sĩ - Cơ Xương Khớp",
                            Position = 1,
                            Price = 250000.0,
                            ServiceCode = "KHAM-CXK-THS",
                            SpecialtyId = new Guid("11111111-1111-1111-1111-111111111101")
                        },
                        new
                        {
                            ...
                            DurationInMinutes = 20,
                            IsActive = true,
                            Name = "Khám PGS - Cơ Xương Khớp",
                            Position = 3,
                            Price = 450000.0,
                            ServiceCode = "KHAM-CXK-PGS",
                            SpecialtyId = new Guid("11111111-1111-1111-1111-111111111101")
                        },
                        new
                        {
                            ...
                            DurationInMinutes = 15,
                            IsActive = true,
                            Name = "Khám Bác sĩ - Tiêu hóa",
                            Position = 0,
                            Price = 200000.0,
                            ServiceCode = "KHAM-TH-BS",
                            SpecialtyId = new Guid("11111111-1111-1111-1111-111111111102")
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            DurationInMinutes = 20,
                            IsActive = true,
                            Name = "Khám PGS - Tiêu hóa",
                            Position = 3,
                            Price = 500000.0,
                            ServiceCode = "KHAM-TH-PGS",
                            SpecialtyId = new Guid("11111111-1111-1111-1111-111111111102")
                        },
                        new
                        {
                            ...
                            DurationInMinutes = 15,
                            IsActive = true,
                            Name = "Khám Bác sĩ - Tim mạch",
                            Position = 0,
                            Price = 250000.0,
                            ServiceCode = "KHAM-TM-BS",
                            SpecialtyId = new Guid("11111111-1111-1111-1111-111111111103")
                        },
                        new
                        {
                            ...
                            DurationInMinutes = 20,
                            IsActive = true,
                            Name = "Khám PGS - Tim mạch",
                            Position = 3,
                            Price = 600000.0,
                            ServiceCode = "KHAM-TM-PGS",
                            SpecialtyId = new Guid("11111111-1111-1111-1111-111111111103")
                        },
                        new
                        {
                            ...
                            DurationInMinutes = 30,
                            IsActive = true,
                            Name = "Khám Giáo sư - Tim mạch",
                            Position = 4,
                            Price = 800000.0,
                            ServiceCode = "KHAM-TM-GS",
                            SpecialtyId = new Guid("11111111-1111-1111-1111-111111111103")
                        });
                });
            ...
            modelBuilder.Entity("BookingCare.Domain.Entities.WorkSession", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DoctorId = new Guid("33333333-3333-3333-3333-333333333301"),
                            EndTime = new DateTime(2026, 4, 1, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            NextAvailableAt = new DateTime(2026, 4, 1, 8, 0, 0, 0, DateTimeKind.Unspecified),
                            StartTime = new DateTime(2026, 4, 1, 8, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 3, 30, 8, 0, 0, 0, DateTimeKind.Unspecified),
                            DoctorId = new Guid("33333333-3333-3333-3333-333333333301"),
                            EndTime = new DateTime(2026, 4, 2, 17, 0, 0, 0, DateTimeKind.Unspecified),
                            NextAvailableAt = new DateTime(2026, 4, 2, 13, 30, 0, 0, DateTimeKind.Unspecified),
                            StartTime = new DateTime(2026, 4, 2, 13, 30, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
