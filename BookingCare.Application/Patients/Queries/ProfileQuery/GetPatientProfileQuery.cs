...
{
    public class GetPatientProfileQuery : IRequest<MethodResult<PatientProfileModel>>
    {
        public Guid? ProfileId { get; set; }
    }

    public class GetPatientProfileQueryHandler : IRequestHandler<GetPatientProfileQuery, MethodResult<PatientProfileModel>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public GetPatientProfileQueryHandler(IUnitOfWork unitOfWork, IHttpContextAccessor httpContextAccessor)
        {
            _unitOfWork = unitOfWork;
            _httpContextAccessor = httpContextAccessor;
        }

        public async Task<MethodResult<PatientProfileModel>> Handle(GetPatientProfileQuery request, CancellationToken cancellationToken)
        {
            ArgumentNullException.ThrowIfNull(request);
            var methodResult = new MethodResult<PatientProfileModel>();
            ...
            methodResult.Result = new PatientProfileModel
            {
