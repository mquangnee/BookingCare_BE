...
namespace BookingCare.Application.Commands.ProfileCmd
{
    ...
    public class ShareUserProfileCommandHandler : IRequestHandler<ShareUserProfileCommand, MethodResult<bool>>
    {
        ...
        public ShareUserProfileCommandHandler(UserManager<User> userManager, IUnitOfWork unitOfWork, INotificationService notificationService, IHttpContextAccessor httpContextAccessor)
        {
