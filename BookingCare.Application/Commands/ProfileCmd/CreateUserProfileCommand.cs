...
{
    public class CreateUserProfileCommand : CreateUserProfileCommandModel, IRequest<MethodResult<bool>>
    {
    }

    public class CreateUserProfileCommandHandler : IRequestHandler<CreateUserProfileCommand, MethodResult<bool>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IGeneratorCodeService _generatorCodeService;

        public CreateUserProfileCommandHandler(IUnitOfWork unitOfWork, IHttpContextAccessor httpContextAccessor, IGeneratorCodeService generatorCodeService)
        {
        ...
        public async Task<MethodResult<bool>> Handle(CreateUserProfileCommand request, CancellationToken cancellationToken)
        {
        ...
        private static bool HasMissingRequiredFields(CreateUserProfileCommand request)
        {
